...
export const DEFAULT_CONFIG: EngineConfig = {
  ...
  no_accel_z_penalty: 1.5,        // +1.5 to z_threshold when no accelerometer data
  no_accel_sustained_multiplier: 2.5, // multiply sustained requirements when no accel
  recent_history_size: 20,        // keep last 20 readings for better sustained check
};
